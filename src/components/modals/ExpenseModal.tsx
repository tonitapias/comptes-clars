...
import { Calendar, User as UserIcon, CheckSquare, Square, AlertCircle, Check, Trash2, X } from 'lucide-react';
...
// Escalat dinàmic de la font per a l'import principal
      ...
      return (
        <button
          ...
          className={`
            ...
            ${isActive 
              ? 'bg-white dark:bg-slate-700 shadow-sm text-primary dark:text-indigo-400 ring-1 ring-black/5 dark:ring-white/5 scale-[1.02]' 
      ...
      <form onSubmit={logic.handleSubmit} className="space-y-8 pb-4"> 
        ...
        <div className="bg-surface-ground -mx-6 -mt-2 px-6 py-8 border-b border-slate-100 dark:border-slate-800 flex flex-col items-center gap-6">
            ...
            <div className="relative group w-full max-w-[80%] text-center">
                ...
                {/* Underline effect */}
                <div className="h-1 w-20 bg-slate-200 dark:bg-slate-700 rounded-full mx-auto mt-2 group-focus-within:bg-primary group-focus-within:w-full transition-all duration-300" />
            </div>
            ...
            <div className="space-y-2">
                ...
                <div className="relative">
                    <select 
                        ...
                        className="w-full p-3.5 pl-4 bg-surface-card border border-slate-200 dark:border-slate-800 rounded-2xl outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 appearance-none font-bold text-content-body transition-all shadow-sm"
                    >
            ...
            <div className="space-y-2">
                ...
                <div className="relative">
                    <input 
                        ...
                        className="w-full p-3.5 pl-4 bg-surface-card border border-slate-200 dark:border-slate-800 rounded-2xl outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 font-bold text-content-body transition-all shadow-sm"
                    />
                    ...
                    return (
                        <button
                            ...
                            className={`
                                ...
                                ${isSelected 
                                    ? `bg-${colorBase}-50 border-${colorBase}-200 text-${colorBase}-700 dark:bg-${colorBase}-900/30 dark:border-${colorBase}-800 dark:text-${colorBase}-300 shadow-sm` 
                                    : 'bg-surface-card border-slate-100 dark:border-slate-800 text-slate-400 hover:border-slate-300 dark:hover:border-slate-700'
                                }
                            `}
                        >
                    ...
                    {isDeleting ? (
                        <div className="flex gap-2 animate-scale-in origin-left">
                            ...
                            <button 
                                ...
                                className="px-5 h-12 rounded-xl bg-status-error text-white font-bold text-sm shadow-md hover:bg-rose-600 active:scale-95 transition-all whitespace-nowrap"
                            >
                                Confirmar
                            </button>
                        </div>
                        ...
                        <button 
                            ...
                            className="w-14 h-14 flex items-center justify-center rounded-2xl bg-rose-50 dark:bg-rose-900/20 text-status-error hover:bg-rose-100 dark:hover:bg-rose-900/40 transition-colors"
                        >
