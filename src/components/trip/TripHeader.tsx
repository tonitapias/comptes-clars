...
import { ArrowLeft, Share2, Settings, FileText, Filter, Users, Moon, Sun, History } from 'lucide-react'; // <--- NOU: History
...
export default function TripHeader({ 
  ...
  onExportPDF,
  onOpenShare,
  onOpenActivity // <--- Rebut
}: TripHeaderProps) {
  
  const navigate = useNavigate(); // <--- Hook de navegació
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex gap-1">
             {/* SOLUCIÓ 1: Navegació explícita a l'inici */}
             <button 
                onClick={() => navigate('/')} 
          ...
          <div className="flex gap-1">
            {/* SOLUCIÓ 2: Botó d'Historial accessible directament */}
            <button 
