...
export const LITERALS = {
  ACTIONS: {
    ...
    REMOVE_MEMBER_SUCCESS: "Participant eliminat del grup",
  ...
  ERRORS: { // --- NOVA SECCIÓ (FASE 2) ---
    ...
    USER_NOT_FOUND: "No s'ha trobat aquest participant al grup",
    CANNOT_REMOVE_DEBTS: "No pots eliminar aquest participant fins que no tingui el saldo a zero.",
